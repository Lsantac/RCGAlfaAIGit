  ...
  public static function verifica_sugestoes_nec ($id_part,$desc_cat,$desc_nec,$obs,$filtra_id_logado){
    ...
    public function incluir_necessidades_part(Request $request) {
      ...
      if($request->hasFile('sel_img')){
          ...
          if($size > 5000000){
              return back()->with('fail', 'A imagem é maior do que o tamanho permitido (5MB)');
          }
          ...
          if($extension == 'jpg' or $extension == 'jpeg' or $extension == 'png'){
              ...
              return back()->with('fail', 'O tipo de imagem não é permitido (são permitidos apenas imagens JPEG ou PNG)');
          }
      }
